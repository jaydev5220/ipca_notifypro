<div class="container py-5">
    ...
    <div style="display: flex;justify-content: center;align-items: center;">
        <h3 class="header_title" style="font-weight: 10 !important;">File Upload Number</h3>
    </div>
    <!-- make table view -->
    <div class="float-right m-4">
        <a href="<?php echo base_url('admin/settings/add_upload_number') ?>" class="btn full-width rounded-0 w-100 mt-5" style="border: 1px solid #000;">Add New</a>
    </div>
    <div class="table_div table-responsive mt-5">
        <table class="table table-borderless mt-3" id="upload_number_list" style="border-collapse: separate;">
            <thead>
                <tr>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#upload_number_list').DataTable({
                ...
                scrollY: '40vh',
                ajax: {
                    url: base_url + 'admin/settings/get_upload_number', // Replace with the correct URL
        ...
        //make delete call
        $(document).on('click', '.delete-upload_number', function() {
            var id = $(this).data('id');
            if (confirm('Are you sure you want to delete this upload number?')) {
                showLoader();
                $.ajax({
                    url: base_url + 'admin/settings/delete_upload_number/' + id,
                    type: 'GET',
                    dataType: 'json',
